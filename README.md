...
* __Geospatial processing__ -- Some geospatial operations are performed including reprojecting and buffering points.  A shapefile of buffered points is also created as output.
