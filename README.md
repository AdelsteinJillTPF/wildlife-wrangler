...
## Features
This framework has certain features that support transparency and user-confidence for analyses and evaluations of species distributions.
...
* __Geospatial processing__ -- Some geospatial operations are performed including re-projecting and buffering points.  A helper function is provided that creates a shapefile of buffered points from wrangler output.
