...
Matthew Rubino (mjrubino@ncsu.edu, [orcid:0000-0003-0651-3053](https://orcid.org/0000-0003-0651-3053)), Jill Adelstein.
...
* __Geospatial processing__ -- Some geospatial operations are performed including re-projecting and buffering points.  A helper function is provided that creates a shapefile of buffered points from an output database.  Spatial filtering is supported: queries can be limited to within geometries (polygons), and spatial restrictions can be assigned to taxa's extents of occurrence.  The user can also specify a continent and/or country within which to return records.
...
* Queries returning > 5,000,000 records.
